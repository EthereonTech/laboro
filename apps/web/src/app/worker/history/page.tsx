          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              <div>
                ...
                <div style={{ fontFamily: '"Bricolage Grotesque", system-ui', fontSize: 28, fontWeight: 800, color: '#7FE6C5', letterSpacing: -0.8, lineHeight: 1 }}>
                ...
                <div key={p.id} style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{
                      ...
                      color: C.text, letterSpacing: -0.3, marginBottom: 3,
                    }}>
                  ...
                  <div style={{ textAlign: 'right', flexShrink: 0 }}>
                    <div style={{
                      ...
                      color: p.status === 'RELEASED' ? C.jadeDeep : C.text, letterSpacing: -0.5,
                    }}>
